...
#ifndef NRF52_MBED_SLOW_PWM_H
#define NRF52_MBED_SLOW_PWM_H
  ...
  #define NRF52_MBED_SLOW_PWM_VERSION       "NRF52_MBED_Slow_PWM v1.1.0"
#endif
...
class NRF52_MBED_TimerInterrupt
{
  ...
  public:
    ...
    bool setFrequency(float frequency, timerCallback callback)
    {
      ...
      {
        PWM_LOGERROR1(F("NRF52_MBED_TimerInterrupt: ERROR: Negative or Too high frequency. Must be <="), _frequency/10.0f);
      ...
      PWM_LOGWARN1(F("NRF52_MBED_TimerInterrupt: Timer ="), NRF52_MBED_TimerName[_timer]);
...
#include "nRF52_MBED_Slow_PWM_ISR.h"

#endif    // NRF52_MBED_SLOW_PWM_H
